...
# 修改 vps 主机名为邮件服务器完整子域名，以修正发件人为：root@$mail_domain 
...
apt update
apt upgrade -y
apt install -y postfix mailutils opendkim opendkim-tools certbot python3-certbot libsasl2-2 sasl2-bin libsasl2-modules
